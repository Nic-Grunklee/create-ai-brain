...
This file loads automatically at the start of every agent session in this vault (Codex, and other CLI agents that read `AGENTS.md`). It is a mirror of `CLAUDE.md`. Do the following before responding to anything else:
